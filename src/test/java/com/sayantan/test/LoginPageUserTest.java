...
import com.sayantan.main.util.Resources;
...
public class LoginPageUserTest {
    ...
    public static Archive<?> createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "test.war")
                .addClasses(Member.class, LoginPageUser.class, Resources.class)
    ...
    public void testRegister() throws Exception {
        ...
        newLogin.setId(123L);
        newLogin.setUserid("jane@mailinator.com");
        newLogin.setPassword("2125551234");
        loginPageUser.validator(newLogin);
        assertNotNull(newLogin.getId());
        log.info(newLogin.getId() + " was persisted with id " + newLogin.getUserid());
    }
